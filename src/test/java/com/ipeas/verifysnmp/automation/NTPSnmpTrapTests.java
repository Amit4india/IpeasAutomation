...
public class NTPSnmpTrapTests {
	
	@Test
	public void checkNTPTrap() throws InterruptedException {
		System.out.println("Starting checkNTPTrap for East");
		Util.simulateStopNtp(eastAutomationAgent);
		...
		Util.simulateStartNtp(eastAutomationAgent);
		WebDriverUtil.findElementByXpath(searchFieldBoxInSplunk).clear();
		System.out.println("checkNTPTrap done for East Glue Server successfully");
